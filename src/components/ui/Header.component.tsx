...
export const Header: FC = () => {
	...
	return (
		<header className='flex flex-wrap mx-auto mb-5 py-4 px-3 rounded-2xl row items-center justify-between  bg-white-bg-light dark:bg-bglight-white max-w-2xl max-h-20'>
			<img
